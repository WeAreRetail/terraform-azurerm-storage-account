...
| <a name="input_access_tier"></a> [access\_tier](#input\_access\_tier) | The access tier for the storage account. Valid options are Hot and Cool. | `string` | `"Hot"` | no |
...
| <a name="input_sftp_enabled"></a> [sftp\_enabled](#input\_sftp\_enabled) | Enable SFTP for the storage account. SFTP support requires `is_hns_enabled` set to `true` | `bool` | `false` | no |
